...
mean_dp_regul= 0.9507*obs_dp_q_test
...
mean_dp_wage= wage_dp_q_test*0.9507
...
```{r}
data_dp= data.frame(cbind(obs_dp_q_test,data_dp_q, wage_dp_q_test,tilpas_pr_q,stat_tilpas_q,stat_reg_q))
