...
COMMENT> yk_ds
BEHAVIORAL> yk_ds
EQ> yk_ds = yk - (P(124) + P(125)*SD1 + P(126)*SD2 + P(127)*SD3) + mean(yk)
COEFF> P(124) P(125) P(126) P(127)
STORE> coe(1)
...
COMMENT> xk_ds_adj?????
BEHAVIORAL> DLOG_XK_DS
EQ> DLOG_XK_DS =  p(651) + p(652)*TSLAG(DLOG_GDP_TP,4) + p(653)*DLOG_RER + p(654)*TSLAG(LOG_XK_DS,1) + p(655)*LOG_GDP_TP,1) + p(657)*D_2008Q2 ' +  xk_ds_adj  
COEFF> P(651) P(653) P(654) P(655) P(657)
STORE> coe(2)
...
EQ> xk = xk_ds + P(172) + P(173)*SD1 + P(174)*SD2 + P(175)*SD3 - mean(xk)  
COEFF> P(172) P(173) P(174) P(175)
STORE> coe(3)
...
#C) CALCULATE log and diff variables. 
